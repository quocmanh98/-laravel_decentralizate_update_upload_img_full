...
Route::prefix('demo/')->group(function () {
    ...
    Route::get('form/upload', [AdminController::class, 'upload'])->name('form.upload');
    Route::post('form/upload/store', [AdminController::class, 'store'])->name('form.upload.store');
    Route::get('form/show', [AdminController::class, 'showUpload'])->name('form.show');

    Route::post('form/upload/multiple/store', [AdminController::class, 'multipleStore'])->name('form.multiple.upload.store');
    Route::get('form/upload/multiple', [AdminController::class, 'uploadMultiple'])->name('form.multiple.upload');
    Route::get('form/show/multiple', [AdminController::class, 'showMultiple'])->name('form.show.multiple');
